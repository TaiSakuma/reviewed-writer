...
profile's Personas section and the writer's `scope.md`, which carries the
scoping notes, settle everything you need.

| Call                | You do                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Outcome line                                                                                                                                                                                                                                     |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `scope`             | The preflight. The payload carries the document and the change driving the revision. Touch no file: the run dir does not exist yet, and you keep nothing from this call.                                                                                                                                                                                                                                                                                                                        | `blocked — <missing path or heading>; copy <template path>`, or `blocked — cannot launch reviewers`, or `scoped — personas: <n>`                                                                                                                 |
...
each persona's verdict); the round in flight, the call in progress, and, once a
call is answered, its outcome line. Write the received call line into it first;
rewrite it before the reviewers are launched or continued, and again after the
matrix is consolidated — carrying the outcome line the reply will open with — so
a panel lost mid-round leaves enough to run the round again.
...
1. **Personas and primaries** — At the run's first `review`, fix the personas
   ...
   the profile's Personas section directs, applying the scoping notes and the
   answers to the open questions as `scope.md` records them, and the change and
   scope stated there; record them in `panel.md` and name them in the reply's
   summary. They hold for the run.
